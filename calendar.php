                            ...
                            <div class="content-body">
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-3">
										...
										$dataArray2[] = array('title'=>"$eventtitle",'startdate'=>"$startdate",'enddate'=>"$enddate"); 
...
?>
                                            ...
                                            <input type="text" id="startdate" name="startdate" value="" placeholder="Start Date" class="form-control datepicker" data-format="yyyy-mm-dd">
                                            <input type="text" id="enddate" name="enddate" value="" placeholder="End Date" class="form-control datepicker" data-format="yyyy-mm-dd">
                                    ...
                                    <div id='crm-calendar-calendar' class="col-md-9 col-sm-9 col-xs-9"></div>
