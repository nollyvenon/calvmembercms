...
<form id="form1" name="form1" method="post" action="" onsubmit="return validateForm()">
            <table width="817" height="141" border="0" cellpadding="0" cellspacing="3">
              <tr>
                <td height="32" colspan="2">
                  <?php
if ($_POST){
$ssusergroup  = $_POST['priv'];
header("location:assignrights2.php?ssusergroup=$ssusergroup");
...
?></td>
              ...
              <tr>
                <td width="101" height="38">User Privileges:</td>
                <td width="707"><select name="priv">
                  <?php
				$qr1 = $db->select('userpriv')->results();
				foreach($qr1 as $fet){
		$accttype=$fet['accttype'];
		$ssusergroup=$fet['usergroup'];
		echo "<option value='$ssusergroup'> $accttype </option>";
							}
