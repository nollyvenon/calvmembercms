...
$qr = $db->select('scheduleemailtemplates',array('*'),$whereCondition)->results();

    foreach ($qr as $row) {
        $id = $row['template_id'];
        $subject = $row['subject'];
        $ntemplate_folder = $row['template'];
        $ntype_id = $row['type'];
	...
	if ($_POST['submit']){			
			...
			$dataArray2[] = array('content'=>"$editor1",'descript'=>"$descript",'type'=>"$category",'template'=>"$templdesign"); 
			$aWhere = array('id'=>"$id"); 
	...
	?>
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input name="descript" value="<?= $subject;?>" class="form-control" type="text"></div>
                                                </div>
                                            <div class="form-group">
