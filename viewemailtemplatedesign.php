                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>ID</th><th>Content Folder</th>  <th>View</th>                  </tr>
                                            </thead>
                                            ...
                                            $qr = $db->select('emailtemplates',array('*'),"",'order BY template_id DESC')->results();
                                            ...
                                            ?>
                                                <tr><td><?php echo $row['template_id']; ?></td><td><?php echo truncate_str(htmlspecialchars_decode($row['template_folder']),50,'...'); ?></td><td><a href="templatedetails.php?sid=<?php echo $row['template_id']; ?>">View</a></td></tr>
                                            <?php					}
                                            }
                                            ?>
                                            </tbody>
