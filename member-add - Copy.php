...
$db->update('members', $dataArray, $aWhere)->affectedRows();
        ...
        <?php  } ?>
                                            ...
                                            <div class="form-group" id="regFrame">
                                            	<div class="col-md-6">
                                                <label class="form-label" for="field-5">Membership Start Date</label>
                                                <div class="controls">
                                                    <input id="cu_mem_stdate" name="cu_mem_stdate" type="text" value="<?= date('d-m-Y',time());?>" class="form-control datepicker" data-format="dd/mm/yyyy" >
                                                </div>
                                                </div>
                                                <div class="col-md-6">
                                                <label class="form-label" for="field-5">Membership End Date</label>
                                                <div class="controls">
                                                    <input id="cu_mem_stdate" name="cu_mem_stdate" type="text" value="<?= date('d-m-Y',time());?>" class="form-control datepicker" data-format="dd/mm/yyyy" >
                                                </div>
                                                </div>
                                ...
                                <div class="row">
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                                <div class="text-left">
                                                    <button id="submprofile" name="submprofile" type="submit" class="btn btn-primary">Save</button>
