                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Template Details</h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <!-- ********************************************** -->
                                            ...
                                            <?php
$id = $_GET['sid'];
                                             $selectFields = array('id','content','template','subject', 'type', 'timestamp');
                                      ...
                                      <b>Subject: </b><?php echo  htmlspecialchars_decode($row['subject']); ?><br>
                                      <b> Template:</b> <?php echo  htmlspecialchars_decode($row['template']); ?><br>
                                      <b> Type:</b><?php echo  htmlspecialchars_decode($row['type']); ?><br>
