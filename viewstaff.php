...
if(!isset($_SESSION['adminname'])){	
  ...
  header("Location:login.php");
	...
	if ($_POST['deletestaff']){
     $hiddel = $_POST['hiddel'];
	$aWhere = array('admkey'=>"$hiddel"); 
$data1 = $db->delete('adminu', $aWhere)->affectedRows();
if ($data1){
	$heifer = "Staff deleted successfully.";
}
	}
...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Calvary Members' CMS : View Staff</title>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            $qr = $db->select('adminu',array('*'),"",'order BY staffid DESC')->results();
                                            $q = $db->count('adminu',"","order BY staffid");
                                            if ($q == 0 ) {
                                            ...
                                            ?>
                                                <tr><td><?php echo $row['staffid']; ?></td><td><?php echo $row['adminname']; ?></td>
                                                <td><?php echo $row['fullname']; ?></td>
                                                <td><?php echo $row['phone']; ?></td>
                                                <td><?php echo $row['email']; ?></td>
                                                <td width="10%"><a class="btn btn-success" href="staff-profile.php?sid=<?= $admkey;?>">View</a></td>
                                                <td width="10%"><a class="btn btn-info" href="staff-edit.php?sid=<?= $admkey;?>">Edit</a></td>
                                                <td width="10%"><a href="#modal-custom-dialog1" class="btn btn-danger" data-toggle="modal" data-id="<?= $admkey;?>">Delete</a></td></tr>
                                            <?php					}
                                            }
                                            ?>
                                            </tbody>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">          
                           ...
                           <form id="form1" name="form1" method="post" action="">  
                                ...
                                <h4 class="modal-title">Delete Staff Approval</h4></div>
                            <div class="modal-body">Are you sure you want to delete this staff category, this process is irreversible.<br><br>
                            <input name="hiddel" type="hidden">
                           </div>
                            <div class="modal-footer">
                                <input name="deletestaff" type="submit" class="btn btn-danger" value="Delete Staff!">
