...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Calvary Members' CMS : This Month Anniversary</title>
    ...
    <?php include('header.php');?>
                        ...
                        <div class="page-title">
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>This Month Anniversary</strong>
                                    </li>
                                </ol>
                            </div>
		...
		$userpass = $conn->query("SELECT * FROM members WHERE MONTH(cu_anniv_date) = MONTH(NOW())"); 
