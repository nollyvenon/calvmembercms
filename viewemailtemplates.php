                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            ?>
                                                <tr><td><?php echo $row['id']; ?></td><td><?php echo truncate_str(htmlspecialchars_decode($row['subject']),50,'...'); ?></td><td><a href="viewemailtemplatedetails.php?sid=<?php echo $row['id']; ?>">Edit</a></td></tr>
                                            <?php					}
                                            }
                                            ?>
                                            </tbody>
