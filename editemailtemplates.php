                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            $selectFields = array('id','content','template','subject', 'timestamp');
                                            $qr = $db->select('scheduleemailtemplates',$selectFields,'order BY id DESC')->results();
                                            $q = $db->count('scheduleemailtemplates',"","order BY id");
                                            if ($q == 0 ) {
                                            ...
                                            ?>
                                                <tr><td><?php echo $row['id']; ?></td><td><?php echo truncate_str(htmlspecialchars_decode($row['subject']),50,'...'); ?></td><td><a href="editemailtemplatedetails.php?sid=<?php echo $row['id']; ?>">Edit</a></td></tr>
                                            <?php					}
                                            }
                                            ?>
                                            </tbody>
