                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            $selectFields = array('cu_id','cu_first_name','cu_last_name', 'cu_phone', 'cu_email','cu_gender', 'cu_city', 'cu_address', 'cu_branch', 'cu_marital_status', 'cu_occupation', 'cu_community', 'cu_address', 'cu_state_origin', 'cu_lga_origin', 'cu_employ_status', 'cu_dob', 'cu_mem_level', 'cu_cell_unit', 'cu_state_of_residence', 'cu_lga', 'timestamp','memkey');
