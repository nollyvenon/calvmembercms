...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Calvary Members' CMS : Marriage Anniversary Remindals</title>
    ...
    <?php include('header.php');?>
        ...
        <div class="page-container row-fluid">
            ...
            <section id="main-content" class=" ">
                        ...
                        <div class="page-title">
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>Upcoming Marriage Anniversary Remindals</strong>
                                    </li>
                                </ol>
                            </div>
             ...
             $userpass = $conn->query("SELECT * FROM  members WHERE  DATE_ADD(cu_marriage_date, 
                INTERVAL YEAR(CURDATE())-YEAR(cu_marriage_date)
                         + IF(DAYOFYEAR(CURDATE()) > DAYOFYEAR(cu_marriage_date),1,0)
                YEAR)  
