...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Calvary Members' CMS : Sellers</title>
                        ...
                        <div class="page-title">
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li>
                                        <a href="frl-sellers.html">Template</a>
                                    </li>
                                    <li class="active">
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Template </h2>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>ID</th><th>Content</th>  <th>Edit</th>                  </tr>
                                            </thead>

                                            <tbody>
                                            <?php

                                            $selectFields = array('template_id','content','template_folder', 'timestamp');
                                            $qr = $db->select('emailtemplates',$selectFields,'order BY template_id DESC')->results();
                                            $q = $db->count('emailtemplates',"","order BY template_id");
                                            if ($q == 0 ) {
                                            ...
                                            ?>
                                                <tr><td><?php echo $row['template_id']; ?></td><td><?php echo truncate_str(htmlspecialchars_decode($row['template_folder']),50,'...'); ?></td><td><a href="edittemplatedetails.php?sid=<?php echo $row['template_id']; ?>">Edit</a></td></tr>
                                            <?php					}
                                            }
                                            ?>
                                            </tbody>
