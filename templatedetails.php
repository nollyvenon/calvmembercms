                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <!-- ********************************************** -->
                                            ...
                                            <?php
$id = $_GET['sid'];
                                            $selectFields = array('template_id','content', 'template_name','template_folder','description', 'timestamp');
                                            $whereCondition = array('template_id ='=>$id);
                                            $qr = $db->select('emailtemplates',$selectFields,$whereCondition,'order BY template_id DESC')->results();
   ...
   // exit;
    ?>
                                      ...
                                      <!-- Description: <?php //echo  htmlspecialchars_decode($row['descript']); ?><br>
                                       Content: <?php //echo  htmlspecialchars_decode($row['content']); ?>-->
