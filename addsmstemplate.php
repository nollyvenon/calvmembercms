...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Calvary Members' CMS : Add SMS Template</title>
                    ...
                    <div class="col-lg-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">ADD SMS TEMPLATE</h2>
...
<?php
	if ($_POST['submit']){			
		...
		//	$sid = $_GET['sid'];
			...
			$dataArray2[] = array('type'=>"$category",'content'=>"$editor1",'descript'=>"$descript",'templatename'=>"$descript"); 
			$data = $db->insertBatch('schedulesmstemplates',$dataArray2)->getAllLastInsertId();
			if ($data){
				echo "<div class=\"btn btn-lg btn-warning btn-block\">Template added Successfully</div>";
			}
	...
	?>
        ...
        <?php  } ?>
                            ...
                            <div class="form-group">
                            <b>Values for use in template creation</b><br>
                                              {$contact.firstname} ==> First Name<br>
                                              {$contact.lastname} ==> Last Name<br>
