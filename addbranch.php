...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Calvary Members' CMS : Add a Branch</title>
                ...
                <section class="wrapper main-wrapper" style=''>
                    ...
                    <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                        <div class="page-title">
                            ...
                            <div class="pull-left">
                                <h1 class="title">Add a Branch</h1>                            </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
                        <section class="box ">
                            <header class="panel_header">
                                <h2 class="title pull-left">Branch</h2>
...
$memkey = md5(uniqid(rand(), true));										
	$dataArray2[] = array('branch_name'=>"$branch"); 
$data = $db->insertBatch('branches',$dataArray2)->getAllLastInsertId();

                                            if ($data){
                                                echo "<div class=\"btn btn-lg btn-warning btn-block\">Branch added Successfully</div>";
                                            }										
}
...
?>
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" value="" name="branch" class="form-control" id="branch">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-8 col-md-8 col-sm-9 col-xs-12 padding-bottom-30">
                                            <div class="text-left">
                                                <input id="addbranch" name="addbranch" type="submit" value="Add Branch" class="btn btn-primary">
