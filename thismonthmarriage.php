...
<html class=" ">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Calvary Members' CMS : This Month Marriage Anniversary</title>
                        ...
                        <div class="page-title">
                            ...
                            <div class="pull-right hidden-xs">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="active">
                                        <strong>This Month Marriage Anniversary</strong>
                                    </li>
                                </ol>
                            </div>
                            ...
                            <div class="content-body">    <div class="row">
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <table id="example" class="display table table-hover table-condensed" cellspacing="0" width="100%">
                                            ...
                                            $selectFields = array('*');
             //$userpass = $conn->query("SELECT * FROM members WHERE MONTH(STR_TO_DATE(cu_dob, '%d/%m/%Y')) = MONTH(NOW())"); 
		//$userpass = $conn->query("select * from members WHERE DATE_FORMAT(cu_dob,'%m') = DATE_FORMAT(NOW(),'%m')");   //this works too
		$userpass = $conn->query("SELECT * FROM members WHERE MONTH(cu_marriage_date) = MONTH(NOW())"); 
